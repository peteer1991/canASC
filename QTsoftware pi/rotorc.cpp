    ...
    ui(new Ui::Rotorc)
{
    ...
    connect(m_workerThread, SIGNAL(msgReceived(QString)), this, SLOT(msgReceived(QString)));
    connect(m_workerThread, SIGNAL(txpower(int,int,int)), this, SLOT(txpower(int,int,int)));
    connect(m_workerThread, SIGNAL(radio_frq(QString)), this, SLOT(Radio_frq(QString)));
    connect(m_workerThread, SIGNAL(Radio_mode(int ,int ,int)), this, SLOT(Radio_mode(int ,int ,int)));

//    connect(m_workerThread, SIGNAL(show_tx()), this, SLOT(show_tx()));
//    connect(m_workerThread, SIGNAL(hide_tx()), this, SLOT(hide_tx()));
