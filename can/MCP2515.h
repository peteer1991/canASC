...
#define MCP_TXB0D0              0x36            //until 0x3d; 8 bytes
...
#define MCP_RXB0D0              0x66            //until 0x6d; 8 bytes
...
void mcp2515_bit_modify(BYTE address, BYTE data, BYTE mask);
void mcp2515_reset();
