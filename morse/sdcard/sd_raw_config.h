...
#elif defined(__AVR_ATxmega128A3__)								// Xmega defines
...
#else
    #define configure_pin_mosi()	PORTE.DIRSET = PIN5_bm;
    #define configure_pin_sck()		PORTE.DIRSET = PIN7_bm;
    #define configure_pin_ss()		PORTE.DIRSET = PIN4_bm;
    #define configure_pin_miso()	PORTE.DIRCLR = PIN6_bm;

    #define select_card()			PORTE.OUTCLR = PIN4_bm;
    #define unselect_card()			PORTE.OUTSET = PIN4_bm;
#endif
